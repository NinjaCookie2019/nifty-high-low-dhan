...
1. **At startup**: Fetches previous trading day's high and low
2. **During market hours**: Checks NIFTY LTP every 5 seconds (configurable)
3. **On breakout**: Sends Telegram alert (once per day per breakout type)
4. **New day**: Resets and fetches new previous day data
